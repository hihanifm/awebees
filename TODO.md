...
## High Priority
- [insights] Add collections to store related insights
- [insights] [storage] Enable users to create their own collections and store them locally on their PC (users can upload to GitHub as they wish)

## Medium Priority
- [insights] Add favorites functionality for insights
- [insights] [ui] Add search functionality for insights
- [insights] [ai/ml] [vector-db] Build vector database for insights and predict insights based on problem insights
